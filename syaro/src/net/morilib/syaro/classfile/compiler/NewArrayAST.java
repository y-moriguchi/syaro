...
/**
 * An abstract syntax tree for constructing an array.
 * 
...
public class NewArrayAST implements AST {
	...
	/**
	 * creates an AST for constructing an array.
	 * 
	 * @param value the type of the array
	...
	public void putCode(FunctionSpace functions, LocalVariableSpace space,
		...
		if(t.equals(Primitive.BYTE)) {
			...
			code.addCode(new ANewArray(ConstantClass.getInstance(
					t.getDescriptor(functions))));
		}
	}
