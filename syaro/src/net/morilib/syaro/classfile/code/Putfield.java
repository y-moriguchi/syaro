...
/**
 * This class represents an Java VM instruction putfield.
 * 
 * @author Yuichiro MORIGUCHI
 */
public class Putfield extends Mnemonic {

	private ConstantFieldref field;

	/**
	 * constructs a putfield.
	 * 
	 * @param field field reference
	 */
	public Putfield(ConstantFieldref field) {
		super(181);
		this.field = field;
	}
