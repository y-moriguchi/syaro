...
/**
 * This class represents a Java VM instruction checkcast.
 * 
 * @author Yuichiro MORIGUCHI
 */
public class Checkcast extends Mnemonic {

	private ConstantClass classe;

	/**
	 * constructs a checkcast instruction.
	 * 
	 * @param classe class definition to cast
	 */
	public Checkcast(ConstantClass classe) {
		super(192);
		this.classe = classe;
	}
