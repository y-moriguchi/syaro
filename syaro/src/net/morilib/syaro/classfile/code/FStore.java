...
/**
 * This class represents a Java VM instruction fstore.
 * 
 * @author Yuichiro MORIGUCHI
 */
public class FStore extends Mnemonic {

	private short index;

	/**
	 * constructs an fstore instruction.
