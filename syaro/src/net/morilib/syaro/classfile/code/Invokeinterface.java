...
/**
 * This class represents an Java VM instruction invokeinterface.
 * 
 * @author Yuichiro MORIGUCHI
 */
public class Invokeinterface extends Mnemonic {

	private ConstantMethodref method;

	/**
	 * constructs a invokeinterface.
	 * 
	 * @param method method reference
	 */
	public Invokeinterface(ConstantMethodref method) {
		super(185);
		this.method = method;
	}
