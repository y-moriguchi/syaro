...
/**
 * This class represents a Java VM instruction istore.
 * 
 * @author Yuichiro MORIGUCHI
 */
public class IStore extends Mnemonic {

	private short index;

	/**
	 * constructs an istore instruction.
