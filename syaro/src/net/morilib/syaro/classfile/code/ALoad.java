...
/**
 * This class represents a Java VM instruction aload.
 * 
 * @author Yuichiro MORIGUCHI
 */
public class ALoad extends Mnemonic {

	private short index;

	/**
	 * constructs an aload instruction.
