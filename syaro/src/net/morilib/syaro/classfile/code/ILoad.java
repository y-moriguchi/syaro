...
/**
 * This class represents a Java VM instruction iload.
 * 
 * @author Yuichiro MORIGUCHI
 */
public class ILoad extends Mnemonic {

	private short index;

	/**
	 * constructs an iload instruction.
