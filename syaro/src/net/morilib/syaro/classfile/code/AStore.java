...
/**
 * This class represents a Java VM instruction astore.
 * 
 * @author Yuichiro MORIGUCHI
 */
public class AStore extends Mnemonic {

	private short index;

	/**
	 * constructs an astore instruction.
